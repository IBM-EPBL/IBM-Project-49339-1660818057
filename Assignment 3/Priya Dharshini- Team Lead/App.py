...
COS_ENDPOINT="http://s3.jp-tok.cloud-object-storage.appdomain.cloud"
COS_API_KEY_ID="9UwesQopCgsTw5BINP8arzzY0eJv3gLycOd1_eGauW_z"
COS_INSTANCE_CRN="crn:v1:bluemix:public:cloud-object-storage:global:a/4b08ab5811a340f2b6c043cac2310629:0ff7d93d-e00b-4fb2-a24d-facded55bd4e::" 
...
@app.route('/')
def index():
    files = get_bucket_contents('wonderla-images')
